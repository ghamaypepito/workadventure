...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    roomInvitation: {
        notification: "Vous avez été invité dans le salon {roomName}",
        notificationTitle: "Nouvelle invitation",
        unknownRoom: "Un salon",
    },
    ...
    question: {
        ...
        send: "Envoyer",
        toAnswer: "À traiter ({count})",
        answeredFilter: "Répondues ({count})",
        answered: "Répondue",
        openStatus: "ouvertes",
        emptyOpen: "Aucune question à traiter pour le moment.",
        emptyAnswered: "Aucune question répondue pour le moment.",
        upvote: "Voter pour la question",
    ...
    addRoomToFolderError: "Impossible d'ajouter le salon au dossier",
    createRoom: {
    ...
    roomPanel: {
        toggleOpen: "Ouvrir le panneau du salon",
        toggleClose: "Fermer le panneau du salon",
        back: "Retour à l'aperçu du salon",
        status: {
        ...
        home: {
            directRoom: "Salon direct",
            groupRoom: "Salon de groupe",
            encrypted: "Chiffré",
        ...
        settings: {
            ...
            joinRule: "Accès",
            restrictedTo: "Restreint à",
            readOnly: "Ces paramètres sont en lecture seule ici.",
            unknown: "Inconnu",
            joinRules: {
                public: "Public",
                invite: "Sur invitation uniquement",
                restricted: "Restreint",
                knock: "Demander l'accès",
            },
        },
    ...
    roomMenu: {
        ...
        muteRoom: "Couper les notifications",
    ...
    e2ee: {
        ...
        createRecoveryKey: {
            ...
            error: "Une erreur est survenue lors de la génération de la clé de récupération",
            buttons: {
                generate: "Générer",
                continue: "Continuer",
                cancel: "Annuler",
    ...
    failedToJoinRoom: "Impossible de rejoindre le salon",
    failedToLeaveRoom: "Impossible de quitter le salon",
    refreshChat: "Rafraîchir le chat",
    dismiss: "Ignorer",
    whoops: "Oups ! une erreur est survenue",
    failedToOpenRoom: "Impossible d'ouvrir le salon : {roomId}",
    failedToSendAttachments: "Échec de l'envoi des pièces jointes. Veuillez réessayer.",
    refreshChatError: "Impossible de rafraîchir le chat",
    discord: {
        chatBand: {
            configure: "Configurer",
            open: "Ouvrir",
