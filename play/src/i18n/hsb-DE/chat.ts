...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    poll: {
        ...
        participants: "{count} hłós(y)",
        multiSelect: "Hač k {count} wuběram",
        ...
        kind: {
            ...
            generic: "Wothłosowanje je so skónčiło.",
            withWinner: "Wothłosowanje je so skónčiło. Naječbnješa wotmołwa: {answer}",
        },
        create: {
            title: "Wothłosowanje wutworić",
            description: "Wutworće wothłosowanje w tutej rumnosći.",
            question: "Prašenje",
            questionPlaceholder: "Stajće prašenje",
            answers: "Wotmołwy",
            addAnswer: "Wotmołwu přidać",
            answerPlaceholder: "Wotmołwa {index}",
            answerCount: "{count}/{max} wotmołwow hotowe",
            visibility: "Widźomnosć",
            openDescription: "Wuslědki su widźomne po wašim hłosowanju.",
            closedDescription: "Wuslědki wostanu schowane, doniž wothłosowanje njeje skónčene.",
            cancel: "Přetorhnyć",
            submit: "Wothłosowanje wutworić",
            validationError: "Zapodajće prašenje a znajmjeńša 2 wotmołwy.",
            submitError: "Wothłosowanje njeda so wutworić. Prošu spytajće hišće raz.",
        },
    },
    question: {
        title: "Prašenja",
        ...
        send: "Pósłać",
        toAnswer: "K wotmołwjenju ({count})",
        answeredFilter: "Wotmołwjene ({count})",
        answered: "Wotmołwjene",
        openStatus: "wočinjene",
        emptyOpen: "Hišće žane prašenje k wotmołwjenju njeje.",
        emptyAnswered: "Hišće žane wotmołwjene prašenje njeje.",
        upvote: "Za prašenje hłosować",
