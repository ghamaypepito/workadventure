...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    poll: {
        ...
        kind: {
            ...
            cta: "투표 종료",
            generic: "투표가 종료되었습니다.",
            withWinner: "투표가 종료되었습니다. 1위 답변: {answer}",
        },
        create: {
            title: "투표 만들기",
            description: "이 방에서 투표를 만듭니다.",
            question: "질문",
            ...
            visibility: "공개 설정",
            openDescription: "투표 후 결과가 표시됩니다.",
            closedDescription: "투표가 종료될 때까지 결과가 숨겨집니다.",
            cancel: "취소",
            submit: "투표 만들기",
            validationError: "질문과 선택지 2개 이상을 입력하세요.",
            submitError: "투표를 만들 수 없습니다. 다시 시도하세요.",
        },
    },
    question: {
        title: "질문",
        ...
        send: "보내기",
        toAnswer: "답변 대기 ({count})",
        answeredFilter: "답변됨 ({count})",
        answered: "답변됨",
        openStatus: "열림",
        emptyOpen: "아직 답변할 질문이 없습니다.",
        emptyAnswered: "아직 답변된 질문이 없습니다.",
        upvote: "질문 추천",
