...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    decline: "Rechazar",
    meetingInvitation: {
        title: "{name} te invita a unirte a la reunión",
        invitationDeclined: "Tu invitación fue rechazada por {name}",
    ...
    imagePreview: {
        ...
        loadError: "No se puede cargar esta vista previa de la imagen.",
    ...
    roomInvitation: {
        notification: "Has sido invitado a la sala {roomName}",
    ...
    thread: {
        ...
        tabLabel: "Hilos",
        empty: "Aún no hay hilos",
        defaultPreview: "Hilo",
        replySingular: "1 respuesta",
    ...
    poll: {
        ...
        kind: {
            ...
            cta: "Cerrar encuesta",
            generic: "Encuesta cerrada.",
            withWinner: "Encuesta cerrada. Respuesta líder: {answer}",
        },
        create: {
            title: "Crear encuesta",
            description: "Cree una encuesta en esta sala.",
            question: "Pregunta",
            questionPlaceholder: "Haga una pregunta",
            answers: "Respuestas",
            addAnswer: "Añadir respuesta",
            answerPlaceholder: "Respuesta {index}",
            answerCount: "{count}/{max} respuestas listas",
            visibility: "Visibilidad",
            openDescription: "Los resultados son visibles después de votar.",
            closedDescription: "Los resultados permanecen ocultos hasta que se cierre la encuesta.",
            cancel: "Cancelar",
            submit: "Crear encuesta",
            validationError: "Introduzca una pregunta y al menos 2 respuestas.",
            submitError: "No se pudo crear la encuesta. Inténtelo de nuevo.",
        },
    },
    question: {
        title: "Preguntas",
        ...
        send: "Enviar",
        toAnswer: "Por responder ({count})",
        answeredFilter: "Respondidas ({count})",
        answered: "Respondida",
        openStatus: "abiertas",
        emptyOpen: "Todavía no hay preguntas por responder.",
        emptyAnswered: "Todavía no hay preguntas respondidas.",
        upvote: "Votar la pregunta",
    ...
    a11y: {
        menuActions: "Menú de acciones",
        unreadCount: "{count} sin leer",
        userAvatar: "Avatar de usuario",
        applicationIcon: "Aplicación",
    },
