...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    poll: {
        ...
        kind: {
            ...
            cta: "结束投票",
            generic: "投票已结束。",
            withWinner: "投票已结束。领先选项：{answer}",
        },
        create: {
            title: "创建投票",
            description: "在此房间创建投票。",
            question: "问题",
            ...
            visibility: "可见性",
            openDescription: "投票后即可查看结果。",
            closedDescription: "在投票结束前结果将隐藏。",
            cancel: "取消",
            submit: "创建投票",
            validationError: "请输入问题和至少 2 个选项。",
            submitError: "无法创建投票，请重试。",
        },
    },
    question: {
        title: "问题",
        ...
        send: "发送",
        toAnswer: "待回答 ({count})",
        answeredFilter: "已回答 ({count})",
        answered: "已回答",
        openStatus: "开放",
        emptyOpen: "暂无待回答的问题。",
        emptyAnswered: "暂无已回答的问题。",
        upvote: "赞同问题",
        markAnswered: "标记为已回答",
        unknownAuthor: "未知",
