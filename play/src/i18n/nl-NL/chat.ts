...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    question: {
        ...
        send: "Verzenden",
        toAnswer: "Te beantwoorden ({count})",
        answeredFilter: "Beantwoord ({count})",
        answered: "Beantwoord",
        openStatus: "open",
        emptyOpen: "Er zijn nog geen vragen om te beantwoorden.",
        emptyAnswered: "Er zijn nog geen beantwoorde vragen.",
        upvote: "Vraag upvoten",
