...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    decline: "Rebutjar",
    meetingInvitation: {
        title: "{name} t'invita a unir-te a la reunió",
        invitationDeclined: "La teva invitació ha estat refusada per {name}",
    ...
    imagePreview: {
        close: "Tancar",
        label: "Vista prèvia de la imatge",
    ...
    roomInvitation: {
        notification: "Has estat convidat a la sala {roomName}",
        notificationTitle: "Nova invitació",
    ...
    poll: {
        ...
        kind: {
            ...
            cta: "Tancar enquesta",
            generic: "Enquesta tancada.",
            withWinner: "Enquesta tancada. Resposta líder: {answer}",
        },
        create: {
            title: "Crear enquesta",
            description: "Creeu una enquesta en aquesta sala.",
            question: "Pregunta",
            questionPlaceholder: "Feu una pregunta",
            answers: "Respostes",
            addAnswer: "Afegir resposta",
            answerPlaceholder: "Resposta {index}",
            answerCount: "{count}/{max} respostes a punt",
            visibility: "Visibilitat",
            openDescription: "Els resultats són visibles després de votar.",
            closedDescription: "Els resultats romanen ocults fins que es tanqui l'enquesta.",
            cancel: "Cancel·lar",
            submit: "Crear enquesta",
            validationError: "Introduïu una pregunta i almenys 2 respostes.",
            submitError: "No s'ha pogut crear l'enquesta. Torneu-ho a provar.",
        },
    },
    question: {
        title: "Preguntes",
        ...
        send: "Envia",
        toAnswer: "Per respondre ({count})",
        answeredFilter: "Respostes ({count})",
        answered: "Resposta",
        openStatus: "obertes",
        emptyOpen: "Encara no hi ha cap pregunta per respondre.",
        emptyAnswered: "Encara no hi ha cap pregunta resposta.",
        upvote: "Vota la pregunta",
