...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    question: {
        ...
        send: "إرسال",
        toAnswer: "للإجابة ({count})",
        answeredFilter: "تمت الإجابة ({count})",
        answered: "تمت الإجابة",
        openStatus: "مفتوحة",
        emptyOpen: "لا توجد أسئلة للإجابة حالياً.",
        emptyAnswered: "لا توجد أسئلة تمت الإجابة عنها حالياً.",
        upvote: "التصويت للسؤال",
