...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    decline: "Rifiuta",
    meetingInvitation: {
        title: "{name} ti invita a unirti alla riunione",
        invitationDeclined: "Il tuo invito è stato rifiutato da {name}",
    ...
    poll: {
        ...
        participants: "{count} voto/i",
        multiSelect: "Fino a {count} scelte",
        ...
        kind: {
            ...
            generic: "Sondaggio chiuso.",
            withWinner: "Sondaggio chiuso. Risposta in testa: {answer}",
        },
        create: {
            title: "Crea sondaggio",
            description: "Crea un sondaggio in questa stanza.",
            question: "Domanda",
            questionPlaceholder: "Fai una domanda",
            answers: "Risposte",
            addAnswer: "Aggiungi risposta",
            answerPlaceholder: "Risposta {index}",
            answerCount: "{count}/{max} risposte pronte",
            visibility: "Visibilità",
            openDescription: "I risultati sono visibili dopo il voto.",
            closedDescription: "I risultati restano nascosti fino alla chiusura del sondaggio.",
            cancel: "Annulla",
            submit: "Crea sondaggio",
            validationError: "Inserisci una domanda e almeno 2 risposte.",
            submitError: "Impossibile creare il sondaggio. Riprova.",
        },
    },
    question: {
        title: "Domande",
        ...
        send: "Invia",
        toAnswer: "Da rispondere ({count})",
        answeredFilter: "Risposte ({count})",
        answered: "Risposta",
        openStatus: "aperte",
        emptyOpen: "Non ci sono ancora domande a cui rispondere.",
        emptyAnswered: "Non ci sono ancora domande risposte.",
        upvote: "Vota la domanda",
